package live.vio.demo

import live.vio.demo.config.DemoConfigurationLoader
import live.vio.demo.demos.DemoRegistry
...
private fun printUsage(items: Collection<live.vio.demo.DemoItem>) {
...
private suspend fun runAllDemos(items: List<live.vio.demo.DemoItem>, config: DemoConfig) {
    items.forEach { item ->
