    ...
    Box(
        ...
        Row(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp), modifier = Modifier.weight(1f)) {
                Text(title, style = ViaplayTheme.Typography.title.copy(fontWeight = FontWeight.Bold), color = Color.White)
                subtitle?.let {
                    Text(it, style = ViaplayTheme.Typography.small, color = Color.White.copy(alpha = 0.8f))
                }
            ...
            Column(
                ...
                Text(
                    text = "Opp til 30%",
                    style = ViaplayTheme.Typography.body.copy(fontWeight = FontWeight.Bold),
                    color = Color.White,
                    modifier = Modifier
...
private fun CountdownUnit(value: Long, label: String) {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(label, style = ViaplayTheme.Typography.small, color = Color.White.copy(alpha = 0.8f))
    }
}
