        ...
        Column(
            ...
            if (isLoading) {
                Row(
                    ...
                    Text("Laster produkt …", style = ViaplayTheme.Typography.body, color = Color.White.copy(alpha = 0.8f))
                }
            } else {
                ProductBody(
...
private fun ProductBody(
    ...
    Row(
        ...
        live.vio.VioUI.Components.compose.product.VioImage(
            url = imageUrl,
        ...
        Column(
            ...
            Text(
                ...
                style = ViaplayTheme.Typography.title.copy(fontWeight = FontWeight.Bold),
                color = Color.White,
            )
            ...
            Text(
                ...
                style = ViaplayTheme.Typography.title,
                color = ViaplayTheme.Colors.primary,
            )
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .background(ViaplayTheme.Colors.primary, RoundedCornerShape(12.dp))
                    .padding(vertical = 12.dp)
                    .clickable { onAddToCart(product) },
                contentAlignment = Alignment.Center,
            ) {
                Text("Legg i kurv", style = ViaplayTheme.Typography.body.copy(fontWeight = FontWeight.Bold), color = Color.Black)
            }
        }
    }
}
