package com.vio.viaplaydemo.ui.components
...
import com.vio.viaplaydemo.services.chat.ChatManager
import com.vio.viaplaydemo.services.chat.ChatMessage
...
fun CastingChatPanel(
    ...
    Column(
        ...
        Row(
            ...
            Text("LIVE CHAT", color = Color.White, style = ViaplayTheme.Typography.small.copy(fontWeight = FontWeight.Bold))
            Text("(${messages.size})", color = Color.White.copy(alpha = 0.7f), style = ViaplayTheme.Typography.small)
            ...
            Column(
                ...
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        textStyle = ViaplayTheme.Typography.small,
                        singleLine = true,
                    ...
                    IconButton(
                            ...
                            if (messageText.isNotBlank()) {
                                chatManager.addMessage(
                                    ChatMessage(
                                        ...
                                        usernameColor = ViaplayTheme.Colors.primary,
                                        likes = 0,
                        ...
                        Icon(imageVector = Icons.Filled.Send, contentDescription = null, tint = if (messageText.isBlank()) Color.White.copy(alpha = 0.4f) else ViaplayTheme.Colors.primary)
                    }
                }
            }
        }
    ...
    Row(
        ...
        Box(
            ...
            Text(
                ...
                style = ViaplayTheme.Typography.small.copy(fontWeight = FontWeight.Bold),
            )
        }
        Column(
            verticalArrangement = Arrangement.spacedBy(3.dp),
        ) {
            Text(message.username, color = message.usernameColor, style = ViaplayTheme.Typography.small.copy(fontWeight = FontWeight.SemiBold))
            Text(
                message.text,
                color = Color.White,
