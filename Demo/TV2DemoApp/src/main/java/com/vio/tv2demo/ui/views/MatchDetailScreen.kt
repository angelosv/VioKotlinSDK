...
import com.vio.tv2demo.ui.components.OfferBannerView
import com.vio.tv2demo.ui.components.TV2VideoPlayer
import com.vio.tv2demo.ui.model.Match
import com.vio.tv2demo.ui.model.MatchMocks
    ...
    Box(modifier = Modifier.fillMaxSize().background(TV2Theme.Colors.background)) {
        Column(
            ...
            VioProductSlider(
                cartManager = cartManager,
                title = "Produkter",
                layout = live.vio.VioUI.Components.VioProductSliderLayout.CARDS,
            )
