...
import live.vio.VioCore.models.BroadcastValidationDto
import live.vio.VioCore.models.BroadcastValidationResult
 ...
 * header `X-Api-Key`. Usa `campaignAdminApiKey` de [live.vio.VioCore.configuration.CampaignConfiguration]
