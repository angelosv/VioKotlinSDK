...
class CartManager(
    ...
    var currency: String by mutableStateOf("NOK")
    var country: String by mutableStateOf("NO")
    ...
    var shippingCurrency: String by mutableStateOf("NOK")
    var markets: List<Market> by mutableStateOf(emptyList())
    var selectedMarket: Market? by mutableStateOf(null)
    var currencySymbol: String by mutableStateOf("kr")
    var phoneCode: String by mutableStateOf("+47")
