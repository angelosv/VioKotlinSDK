package live.vio.VioDesignSystem.Tokens

import live.vio.VioCore.configuration.VioConfiguration
import live.vio.VioCore.configuration.ThemeMode
import live.vio.VioCore.configuration.ThemeColors

/**
 * Static color tokens for the Vio Design System.
 * Values are resolved dynamically based on the current theme configured in [live.vio.VioCore.configuration.VioConfiguration].
