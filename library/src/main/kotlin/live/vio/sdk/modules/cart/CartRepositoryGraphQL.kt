package live.vio.sdk.modules.cart

import live.vio.sdk.core.errors.SdkException
import live.vio.sdk.core.graphql.GraphQLHttpClient
import live.vio.sdk.core.graphql.operations.CartGraphQL
import live.vio.sdk.core.helpers.GraphQLPick
import live.vio.sdk.core.validation.Validation
import live.vio.sdk.domain.models.CartDto
import live.vio.sdk.domain.models.GetLineItemsBySupplierDto
import live.vio.sdk.domain.models.LineItemInput
import live.vio.sdk.domain.models.RemoveCartDto
...
class CartRepositoryGraphQL(
    ...
    override suspend fun addItem(cartId: String, lineItems: List<LineItemInput>): CartDto {
        ...
        if (lineItems.isEmpty()) {
            throw live.vio.sdk.core.errors.ValidationException(
